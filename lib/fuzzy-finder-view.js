...
export default class FuzzyFinderView {
  ...
  hide () {
    ...
    // Check if any other modal is visible. You don't want to give focus to
    // something covered by a modal.
    const modalVisible = atom.workspace.getModalPanels().some(modal => modal.visible)

    if (this.previouslyFocusedElement && !modalVisible) {
